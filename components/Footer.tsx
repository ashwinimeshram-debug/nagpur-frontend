...
export default function Footer() {
  ...
  const visibleSocials = SOCIAL_LINKS.filter(
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center border-b border-gray-700 pb-6">
          ...
          <div className="text-sm text-white-400 mb-4 md:mb-0">
            © {new Date().getFullYear()} {settings.site_name || "Nagpur Realty Hub"}. All rights reserved.
          </div>
            ...
            {visibleSocials.length > 0 ? (
              visibleSocials.map((s) => (
                <a
                  ...
                  title={s.label}
                  className="w-9 h-9 bg-white/10 hover:bg-white/25 rounded-full flex items-center justify-center transition"
                >
                  {s.icon}
                </a>
              ))
